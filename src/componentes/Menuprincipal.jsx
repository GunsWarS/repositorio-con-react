...
function Menuprincipal({ name, imagen, precio }) {
  return (
    <div className='card'>
      <img className='card-img-top'
        src={imagen}
        alt='imagen producto2' />
      ...
      <div className='card-body text-center bg-primary text-white p-5'>
        ...
        <a href='#!' className='btn btn-success fs-3 fw-bold text-uppercase py-3 d-block'>Agregar al carrito</a>
      </div>
    </div>
  )
}
