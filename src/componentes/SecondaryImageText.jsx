...
function SecondaryImagenText() {
  return (
    <div className='container-xl py-5'>
      <div className='row g-0 pt-5 mb-4'>
        <h2 className='text-products'>Nuestros Productos</h2>
        ...
        <div className='col-md-4 bg-primary text-center p-5 text-white d-flex flex-column justify-content-center'>
          ...
          <a className='btn btn-success fs-3 fw-bold text-uppercase py-3'
...
export default SecondaryImagenText;